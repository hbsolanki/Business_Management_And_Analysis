...
} });` : formatMuiErrorMessage2(12, name ? ` (${name})` : "", JSON.stringify(color3.main)));
    }
...
function useDefaultProps({
  ...
  const ctx2 = React27.useContext(PropsContext);
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React30.useCallback((mode2) => {
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme2 = () => React31.useContext(ColorSchemeContext) || defaultContext;
  function CssVarsProvider2(props) {
    ...
    const ctx2 = React31.useContext(ColorSchemeContext);
...
function SeriesProvider(props) {
  ...
  const formattedSeries = React54.useMemo(() => ({
    isInitialized: true,
...
function useSeries() {
  const {
    isInitialized,
    data
  } = React55.useContext(SeriesContext);
  if (!isInitialized) {
...
function usePieSeries() {
  ...
  return React55.useMemo(() => series.pie, [series.pie]);
}
function useLineSeries() {
  const series = useSeries();
  return React55.useMemo(() => series.line, [series.line]);
}
function useBarSeries() {
  const series = useSeries();
  return React55.useMemo(() => series.bar, [series.bar]);
}
...
var CartesianContext = React56.createContext({
  isInitialized: false,
  data: {
    xAxis: {},
    yAxis: {},
...
var rgb_default = function rgbGamma(y2) {
  ...
  function rgb3(start3, end2) {
    var r = color3((start3 = rgb(start3)).r, (end2 = rgb(end2)).r), g = color3(start3.g, end2.g), b = color3(start3.b, end2.b), opacity = nogamma(start3.opacity, end2.opacity);
    return function(t) {
      start3.r = r(t);
      start3.g = g(t);
      start3.b = b(t);
...
var defaultGenerator4 = (componentName) => componentName;
var createClassNameGenerator4 = () => {
  let generate = defaultGenerator4;
  return {
    configure(generator) {
      generate = generator;
    },
    ...
    reset() {
      generate = defaultGenerator4;
    }
  };
};
var ClassNameGenerator4 = createClassNameGenerator4();
var ClassNameGenerator_default4 = ClassNameGenerator4;

// node_modules/@mui/utils/esm/generateUtilityClass/generateUtilityClass.js
var globalStateClasses3 = {
  active: "active",
  checked: "checked",
  completed: "completed",
  disabled: "disabled",
...
function generateUtilityClass4(componentName, slot, globalStatePrefix = "Mui") {
  const globalStateClass = globalStateClasses3[slot];
  return globalStateClass ? `${globalStatePrefix}-${globalStateClass}` : `${ClassNameGenerator_default4.generate(componentName)}-${slot}`;
}
...
function generateUtilityClasses3(componentName, slots, globalStatePrefix = "Mui") {
  const result = {};
  slots.forEach((slot) => {
    result[slot] = generateUtilityClass4(componentName, slot, globalStatePrefix);
  });
  return result;
}
...
var HighlightedContext = React62.createContext({
  isInitialized: false,
  data: {
...
function useControlled2({
  ...
  } = React64.useRef(controlled !== void 0);
  const [valueState, setValue] = React64.useState(defaultProp);
  ...
  const setValueIfUncontrolled = React64.useCallback((newValue) => {
    if (!isControlled) {
      setValue(newValue);
    }
  }, []);
...
function HighlightedProvider({
  ...
  const series = useSeries();
  const seriesById = React65.useMemo(() => {
  ...
  const providerValue = React65.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
...
var createHost = (components, {
  ...
  const animated2 = (Component) => {
    const displayName = getDisplayName3(Component) || "Anonymous";
    if (is.str(Component)) {
...
var getDisplayName3 = (arg2) => is.str(arg2) ? arg2 : arg2 && is.str(arg2.displayName) ? arg2.displayName : is.fun(arg2) && arg2.name || null;
...
function useChartId() {
  ...
  return React70.useMemo(() => chartId, [chartId]);
}
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime25.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime25.jsxs)(React73.Fragment, {
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React77.useContext(AnimationContext);
  if (!isInitialized) {
...
function AnimationProvider(props) {
  ...
  return (0, import_jsx_runtime28.jsx)(AnimationContext.Provider, {
    value,
    children
  });
}
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React79.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var ChartsSurface = React80.forwardRef(function ChartsSurface2(inProps, ref) {
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React81.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React81.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};

// node_modules/@mui/x-charts/ChartContainer/useChartContainerProps.js
var _excluded4 = ["width", "height", "series", "margin", "xAxis", "yAxis", "zAxis", "colors", "dataset", "sx", "title", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "children", "skipAnimation"];
var useChartContainerProps = (props, ref) => {
  ...
  const svgRef = React82.useRef(null);
...
var ChartContainer = React83.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
...
var useEnhancedEffect = typeof window !== "undefined" ? React84.useLayoutEffect : React84.useEffect;
...
var useChartContainerDimensions = (inWidth, inHeight, resolveSizeBeforeRender) => {
  const stateRef = React85.useRef({
    displayError: false,
    initialCompute: true,
    computeRun: 0
  });
  const rootRef = React85.useRef(null);
  const [width2, setWidth] = React85.useState(0);
  const [height2, setHeight] = React85.useState(0);
  const computeSize = React85.useCallback(() => {
...
var ResponsiveChartContainer = React86.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
...
function getAxisUtilityClass(slot) {
  return generateUtilityClass4("MuiChartsAxis", slot);
}
var axisClasses = generateUtilityClasses3("MuiChartsAxis", ["root", "line", "tickContainer", "tick", "tickLabel", "label", "directionX", "directionY", "top", "bottom", "left", "right"]);
...
function ChartsText(props) {
  ...
  const wordsByLines = React94.useMemo(() => getWordsByLines({
    style: style4,
...
var useUtilityClasses2 = (ownerState) => {
  ...
  return composeClasses3(slots, getAxisUtilityClass, classes);
};
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime35.jsxs)(React98.Fragment, {
...
var refType3 = import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object]);
var refType_default3 = refType3;
...
function isClassComponent5(elementType) {
  const {
    prototype = {}
  } = elementType;
  return Boolean(prototype.isReactComponent);
}
function acceptingRef3(props, propName, componentName, location, propFullName) {
  const element = props[propName];
  const safePropName = propFullName || propName;
  if (element == null || // When server-side rendering React doesn't warn either.
  // This is not an accurate check for SSR.
  ...
  let warningHint;
  const elementType = element.type;
  if (typeof elementType === "function" && !isClassComponent5(elementType)) {
    warningHint = "Did you accidentally use a plain function component for an element instead?";
  }
  if (warningHint !== void 0) {
    return new Error(`Invalid ${location} \`${safePropName}\` supplied to \`${componentName}\`. Expected an element that can hold a ref. ${warningHint} For more information see https://mui.com/r/caveat-with-refs-guide`);
...
var elementAcceptingRef3 = chainPropTypes3(import_prop_types34.default.element, acceptingRef3);
elementAcceptingRef3.isRequired = chainPropTypes3(import_prop_types34.default.element.isRequired, acceptingRef3);

// node_modules/@mui/material/node_modules/@mui/utils/esm/elementTypeAcceptingRef/elementTypeAcceptingRef.js
var import_prop_types35 = __toESM(require_prop_types());
function isClassComponent6(elementType) {
  const {
    prototype = {}
  } = elementType;
  return Boolean(prototype.isReactComponent);
...
function elementTypeAcceptingRef3(props, propName, componentName, location, propFullName) {
  ...
  let warningHint;
  if (typeof propValue === "function" && !isClassComponent6(propValue)) {
    warningHint = "Did you accidentally provide a plain function component instead?";
  }
  if (warningHint !== void 0) {
    return new Error(`Invalid ${location} \`${safePropName}\` supplied to \`${componentName}\`. Expected an element type that can hold a ref. ${warningHint} For more information see https://mui.com/r/caveat-with-refs-guide`);
...
var elementTypeAcceptingRef_default3 = chainPropTypes3(import_prop_types35.default.elementType, elementTypeAcceptingRef3);
...
var import_react_is4 = __toESM(require_react_is5());

// node_modules/@mui/material/node_modules/@mui/utils/esm/ponyfillGlobal/ponyfillGlobal.js
var ponyfillGlobal_default3 = typeof window != "undefined" && window.Math == Math ? window : typeof self != "undefined" && self.Math == Math ? self : Function("return this")();
...
var useEnhancedEffect2 = typeof window !== "undefined" ? React100.useLayoutEffect : React100.useEffect;
var useEnhancedEffect_default4 = useEnhancedEffect2;
...
var maybeReactUseId3 = safeReact3.useId;
...
function getTypeByValue3(value) {
  const valueType = typeof value;
  switch (valueType) {
    case "number":
      if (Number.isNaN(value)) {
...
function requiredInteger3(props, propName, componentName, location) {
  const propValue = props[propName];
  if (propValue == null || !Number.isInteger(propValue)) {
    const propType = getTypeByValue3(propValue);
    return new RangeError(`Invalid ${location} \`${propName}\` of type \`${propType}\` supplied to \`${componentName}\`, expected \`integer\`.`);
  }
  return null;
}
function validator3(props, propName, ...other) {
  const propValue = props[propName];
  if (propValue === void 0) {
    return null;
  }
  return requiredInteger3(props, propName, ...other);
}
function validatorNoop3() {
  return null;
}
validator3.isRequired = requiredInteger3;
validatorNoop3.isRequired = validatorNoop3;
...
function generateUtilityClasses4(componentName, slots, globalStatePrefix = "Mui") {
  const result = {};
  slots.forEach((slot) => {
...
var isHostComponent_default3 = isHostComponent2;
...
function appendOwnerState2(elementType, otherProps, ownerState) {
  if (elementType === void 0 || isHostComponent_default3(elementType)) {
    return otherProps;
  }
  return {
    ...otherProps,
...
var appendOwnerState_default3 = appendOwnerState2;
...
var extractEventHandlers_default3 = extractEventHandlers2;
...
var omitEventHandlers_default3 = omitEventHandlers2;
...
function mergeSlotProps2(parameters) {
  ...
  const eventHandlers = extractEventHandlers_default3({
    ...externalForwardedProps,
    ...externalSlotProps
  });
  const componentsPropsWithoutEventHandlers = omitEventHandlers_default3(externalSlotProps);
  const otherPropsWithoutEventHandlers = omitEventHandlers_default3(externalForwardedProps);
  const internalSlotProps = getSlotProps(eventHandlers);
  const joinedClasses = clsx_default(internalSlotProps == null ? void 0 : internalSlotProps.className, additionalProps == null ? void 0 : additionalProps.className, className, externalForwardedProps == null ? void 0 : externalForwardedProps.className, externalSlotProps == null ? void 0 : externalSlotProps.className);
  const mergedStyle = {
...
var mergeSlotProps_default3 = mergeSlotProps2;
...
var resolveComponentProps_default3 = resolveComponentProps2;
...
function useSlotProps2(parameters) {
  ...
  const resolvedComponentsProps = skipResolvingSlotProps ? {} : resolveComponentProps_default3(externalSlotProps, ownerState);
  const {
    props: mergedProps,
    internalRef
  } = mergeSlotProps_default3({
    ...other,
    externalSlotProps: resolvedComponentsProps
  });
  const ref = useForkRef3(internalRef, resolvedComponentsProps == null ? void 0 : resolvedComponentsProps.ref, (_a = parameters.additionalProps) == null ? void 0 : _a.ref);
  const props = appendOwnerState_default3(elementType, {
    ...mergedProps,
    ref
  }, ownerState);
  return props;
}
var useSlotProps_default3 = useSlotProps2;
...
function getReactNodeRef2(element) {
  if (!element || !React109.isValidElement(element)) {
    return null;
  }
...
var Portal = React110.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  } = props;
  const [mountNode, setMountNode] = React110.useState(null);
  const handleRef = useForkRef3(getReactNodeRef2(children), forwardedRef);
  useEnhancedEffect_default4(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React110.isValidElement(children)) {
      ...
      return React110.cloneElement(children, newProps);
    }
    return (0, import_jsx_runtime36.jsx)(React110.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime36.jsx)(React110.Fragment, {
...
true ? Portal.propTypes = {
   ...
   */
  container: import_prop_types36.default.oneOfType([HTMLElementType3, import_prop_types36.default.func]),
  /**
...
if (true) {
  Portal["propTypes"] = exactProp4(Portal.propTypes);
}
var Portal_default = Portal;

// node_modules/@mui/material/Popper/popperClasses.js
function getPopperUtilityClass(slot) {
  return generateUtilityClass3("MuiPopper", slot);
}
var popperClasses = generateUtilityClasses4("MuiPopper", ["root"]);
...
var useUtilityClasses4 = (ownerState) => {
  ...
  return composeClasses4(slots, getPopperUtilityClass, classes);
};
var defaultPopperOptions = {};
var PopperTooltip = React111.forwardRef(function PopperTooltip2(props, forwardedRef) {
  const {
    anchorEl,
    children,
    direction,
  ...
  const rootProps = useSlotProps_default3({
    elementType: Root,
...
var Popper = React111.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children,
  ...
  if (containerProp) {
    ...
    container = resolvedAnchorEl && isHTMLElement2(resolvedAnchorEl) ? ownerDocument3(resolvedAnchorEl).body : ownerDocument3(null).body;
  }
...
true ? Popper.propTypes = {
   ...
   */
  anchorEl: chainPropTypes3(import_prop_types37.default.oneOfType([HTMLElementType3, import_prop_types37.default.object, import_prop_types37.default.func]), (props) => {
    if (props.open) {
   ...
   * so it's simply `document.body` most of the time.
   */
  container: import_prop_types37.default.oneOfType([HTMLElementType3, import_prop_types37.default.func]),
  /**
...
function GlobalStyles3(props) {
  return (0, import_jsx_runtime38.jsx)(GlobalStyles_default, {
    ...props,
    defaultTheme: defaultTheme_default,
    themeId: identifier_default
  });
...
function DefaultPropsProvider2(props) {
  return (0, import_jsx_runtime40.jsx)(DefaultPropsProvider_default, {
    ...props
  });
}
true ? DefaultPropsProvider2.propTypes = {
   ...
   * @ignore
   */
  value: import_prop_types39.default.object.isRequired
} : void 0;
...
var Popper3 = React115.forwardRef(function Popper4(inProps, ref) {
  ...
  return (0, import_jsx_runtime41.jsx)(PopperRoot, {
    as: component,
...
true ? Popper3.propTypes = {
   ...
   * The return value will passed as the reference object of the Popper instance.
   */
  anchorEl: import_prop_types40.default.oneOfType([HTMLElementType3, import_prop_types40.default.object, import_prop_types40.default.func]),
  /**
   * Popper render function or node.
   */
   ...
   * so it's simply `document.body` most of the time.
   */
  container: import_prop_types40.default.oneOfType([HTMLElementType3, import_prop_types40.default.func]),
  /**
   * The `children` will be under the DOM hierarchy of the parent component.
   * @default false
   */
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime42.jsx)(React116.Fragment, {
...
if (true) {
  NoSsr["propTypes"] = exactProp4(NoSsr.propTypes);
}
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React117.useState(null);
  React117.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function getChartsTooltipUtilityClass(slot) {
  return generateUtilityClass4("MuiChartsTooltip", slot);
}
var chartsTooltipClasses = generateUtilityClasses3("MuiChartsTooltip", ["root", "paper", "table", "row", "cell", "mark", "markCell", "labelCell", "valueCell"]);
...
true ? DefaultChartsItemTooltipContent.propTypes = {
   ...
   */
  getColor: import_prop_types42.default.func.isRequired,
  /**
   * The data used to identify the triggered item.
   */
  itemData: import_prop_types42.default.shape({
    ...
    type: import_prop_types42.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
  }).isRequired,
  /**
...
var capitalize_default = capitalize4;
...
var typographyClasses = generateUtilityClasses4("MuiTypography", ["root", "h1", "h2", "h3", "h4", "h5", "h6", "subtitle1", "subtitle2", "body1", "body2", "inherit", "button", "caption", "overline", "alignLeft", "alignRight", "alignCenter", "alignJustify", "noWrap", "gutterBottom", "paragraph"]);
...
var useUtilityClasses5 = (ownerState) => {
  ...
  return composeClasses4(slots, getTypographyUtilityClass, classes);
};
...
var Typography = React120.forwardRef(function Typography2(inProps, ref) {
  const {
    color: color3,
    ...themeProps
  } = useDefaultProps2({
  ...
  return (0, import_jsx_runtime45.jsx)(TypographyRoot, {
    as: Component,
    ref,
    className: clsx_default(classes.root, className),
    ...other,
      ...
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime46.jsx)("thead", {
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime46.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime46.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color3 && (0, import_jsx_runtime46.jsx)(ChartsTooltipMark, {
                color: color3,
                className: classes.mark
              })
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types44.default.object.isRequired,
  /**
...
function ChartsAxisTooltipContent(props) {
  ...
  const {
    zAxisIds,
    zAxis
  } = React122.useContext(ZAxisContext);
  const series = useSeries();
  const colorProcessors = useColorProcessor();
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React122.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React122.useMemo(() => {
...
var useUtilityClasses6 = (ownerState) => {
  ...
  return composeClasses3(slots, getChartsTooltipUtilityClass, classes);
};
...
function getLegendUtilityClass(slot) {
  return generateUtilityClass4("MuiChartsLegend", slot);
}
var legendClasses = generateUtilityClasses3("MuiChartsLegend", ["root", "series", "itemBackground", "mark", "label", "column", "row"]);
...
function ChartsLegendItem(props) {
  ...
  return (0, import_jsx_runtime49.jsxs)("g", {
    ...
    }), (0, import_jsx_runtime49.jsx)("rect", {
...
function LegendPerItem(props) {
  ...
  const theme = useTheme5();
  const drawingArea = useDrawingArea();
  const labelStyle = React127.useMemo(
  ...
  const padding2 = React127.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React127.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React127.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React127.useMemo(() => {
  ...
  return (0, import_jsx_runtime50.jsx)(NoSsr_default, {
    children: (0, import_jsx_runtime50.jsx)(ChartsLegendRoot, {
...
function DefaultChartsLegend(props) {
  ...
  return (0, import_jsx_runtime51.jsx)(LegendPerItem, _extends({}, other, {
...
true ? DefaultChartsLegend.propTypes = {
  ...
  seriesToDisplay: import_prop_types46.default.arrayOf(import_prop_types46.default.shape({
    ...
    itemId: import_prop_types46.default.oneOfType([import_prop_types46.default.number, import_prop_types46.default.string]),
    label: import_prop_types46.default.string.isRequired,
    maxValue: import_prop_types46.default.oneOfType([import_prop_types46.default.instanceOf(Date), import_prop_types46.default.number]),
    minValue: import_prop_types46.default.oneOfType([import_prop_types46.default.instanceOf(Date), import_prop_types46.default.number]),
...
var useUtilityClasses7 = (ownerState) => {
  ...
  return composeClasses3(slots, getLegendUtilityClass, classes);
};
function ChartsLegend(inProps) {
  ...
  return (0, import_jsx_runtime52.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
...
function useAxis({
  ...
  const {
    zAxis,
    zAxisIds
  } = React130.useContext(ZAxisContext);
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime53.jsxs)(React131.Fragment, {
    children: [(0, import_jsx_runtime53.jsx)(ChartsContinuousGradient, {
      isReversed,
      gradientId: id,
      size,
    ...
    }), (0, import_jsx_runtime53.jsx)("rect", _extends({
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types48.default.oneOf(["end", "middle", "start"]),
  /**
   * The axis direction containing the color configuration to represent.
   * @default 'z'
   */
  axisDirection: import_prop_types48.default.oneOf(["x", "y", "z"]),
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types48.default.oneOfType([import_prop_types48.default.number, import_prop_types48.default.string]),
  /**
   ...
   */
  maxLabel: import_prop_types48.default.oneOfType([import_prop_types48.default.func, import_prop_types48.default.string]),
  /**
   * The label to display at the minimum side of the gradient.
   * Can either be a string, or a function.
   * @default ({ formattedValue }) => formattedValue
   */
  minLabel: import_prop_types48.default.oneOfType([import_prop_types48.default.func, import_prop_types48.default.string]),
  /**
   * The position of the legend.
   */
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types48.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
   * The space between the gradient bar and the labels.
   * @default 4
   */
  spacing: import_prop_types48.default.number,
  /**
...
function PiecewiseColorLegend(props) {
  ...
  return (0, import_jsx_runtime54.jsx)(LegendPerItem, _extends({}, other, {
    itemsToDisplay,
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default 'z'
   */
  axisDirection: import_prop_types49.default.oneOf(["x", "y", "z"]),
  /**
   * The id of the axis item with the color configuration to represent.
   * @default The first axis item.
   */
   ...
   * @default false
   */
  hideFirst: import_prop_types49.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types49.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
   ...
   */
  labelFormatter: import_prop_types49.default.func,
  /**
   * Style applied to legend labels.
   * @default theme.typography.subtitle1
   */
...
function getAxisHighlightUtilityClass(slot) {
  return generateUtilityClass4("MuiChartsAxisHighlight", slot);
}
var chartsAxisHighlightClasses = generateUtilityClasses3("MuiChartsAxisHighlight", ["root"]);
var useUtilityClasses8 = () => {
  const slots = {
    root: ["root"]
  };
  return composeClasses3(slots, getAxisHighlightUtilityClass);
};
...
function ChartsAxisHighlight(props) {
  ...
  const {
    axis
  } = React133.useContext(InteractionContext);
  ...
  return (0, import_jsx_runtime55.jsxs)(React133.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime55.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime55.jsx)(ChartsAxisHighlightPath, {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime55.jsx)(ChartsAxisHighlightPath, {
      d: `M ${getXPosition(axis.x.value)} ${yScale.range()[0]} L ${getXPosition(axis.x.value)} ${yScale.range()[1]}`,
      className: classes.root,
      ownerState: {
        axisHighlight: "line"
      }
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime55.jsx)(ChartsAxisHighlightPath, {
...
export {
  ...
  generateUtilityClass4 as generateUtilityClass,
...
@mui/system/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-WWOSU774.js.map
